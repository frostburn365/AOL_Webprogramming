...
namespace App\Models {
     ...
     *
     * @method static \Illuminate\Database\Eloquent\Builder<JournalEntry>|JournalEntry newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<JournalEntry>|JournalEntry newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<JournalEntry>|JournalEntry query()
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereUsername($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth wherePhonenumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth wherePassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereRememberToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserAuth>|UserAuth query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class UserAuth extends \Illuminate\Foundation\Auth\User
    {
        //
    }
